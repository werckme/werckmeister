...
assert(sysexStr == "41 10 00 00 64 12 19 02 00 10 7f 56")

nodeinfo.node:setvalue(121)
sysex = Create_SysexMessage(nodeinfo, 23)
sysexStr = Bytes_To_String(sysex)
assert(sysexStr == "41 17 00 00 64 12 19 02 00 10 79 5c")
...
sysexStr = Bytes_To_String(sysex)
assert(sysexStr == "41 10 00 00 64 12 02 00 00 00 00 07 0e 08 61")
...
sysex = Create_SysexMessage(nodeinfo)
sysexStr = Bytes_To_String(sysex)
assert(sysexStr == "41 10 00 00 64 12 02 00 00 26 0f 0a 3f")
...
sysex = Create_SysexMessage(nodeinfo)
sysexStr = Bytes_To_String(sysex)
assert(sysexStr == "41 10 00 00 64 12 19 00 00 00 30 31 32 33 34 35 20 20 20 20 20 20 78")