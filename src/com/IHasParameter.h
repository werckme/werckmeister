...
#define FM_PARAMETER_DEF(name, position) { com::String(name), com::Parameter(name, position) }
#define FM_PARAMETER_DEFAULT_DEF(name, position, defaultValue) { com::String(name), com::Parameter(name, position, defaultValue) }
namespace com
{
    class IHasParameter {
    public:
