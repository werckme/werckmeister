...
namespace com
{
    ...
    */
    ...
    public:
        ...
        T calc(T t, Int2Type<TweenTypeQuad>) const
        {
            auto p = t / d;
            return c * p * p + b;
        }
        T calc(T t, Int2Type<TweenTypeCub>) const
        {
            auto p = t / d;
            return c * p * p * p + b;
        }
        T calc(T t, Int2Type<TweenTypeQuart>) const
        {
            auto p = t / d;
            return c * p * p * p * p + b;
        }
        T calc(T t, Int2Type<TweenTypeQuint>) const
        {
            auto p = t / d;
            return c * p * p * p * p * p + b;
        }
        T calc(T t, Int2Type<TweenTypeExp>) const
        {
            auto p = t / d;
            return c * std::pow(T(2.0), T(10.0) * (p - T(1.0))) + b;
        }
    };
}
