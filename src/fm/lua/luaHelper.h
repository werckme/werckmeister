...
namespace sheet {
    ...
    namespace lua {
        ...
        inline void getTableValue(lua_State *L, const char *key, fm::String& out) {
            lua_pushstring(L, key);
            lua_gettable(L, -2);         
        ...
        inline void setTableValue(lua_State *L, const char *key, int stackIndex, const fm::String &value) {
            lua_pushstring(L, key);
