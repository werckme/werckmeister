...
public:
    SheetCompilerProgramJs(
        ...
        documentModel::conductor::IConductionsPerformerPtr conductionsPerformer) : SheetCompilerProgram(programOptions, logger, documentParser, compiler, context, preprocessor, midiFile, documentWriter, conductionsPerformer)
    {
    }
