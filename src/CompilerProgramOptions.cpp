...
#define ARG_END "end"
#define ARG_CREATE_DEBUG_SYMBOLS "create-debug-symbols"
...
Validate mode checks for errors and returns the validation result as json object.")
    (ARG_CREATE_DEBUG_SYMBOLS, "adds debug infos to the json output")
...
bool CompilerProgramOptions::isGenerateDebugSymbolsSet() const 
{
    return !!variables.count(ARG_CREATE_DEBUG_SYMBOLS);
}
