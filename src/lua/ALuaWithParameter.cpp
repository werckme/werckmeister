...
namespace lua
{
    com::IHasParameter::ParametersByNames &ALuaWithParameter::getParameters(lua_State *L)
    {
    ...
    com::IHasParameter::ParametersByNames ALuaWithParameter::popParameters(lua_State *L)
    {
        com::IHasParameter::ParametersByNames result;
        lua_pushnil(L);
        int pos = 0;
    ...
    void ALuaWithParameter::pushParameters(lua_State *L, const com::IHasParameter::ParametersByNames &parameters)
    {
