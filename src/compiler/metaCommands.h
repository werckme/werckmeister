...
#define SHEET_META__TRACK_META_KEY_TEMPLATE_TYPE FM_STRING("template")
...
#define SHEET_META__DEFINE_INSTRUMENT_SECTION FM_STRING("instrumentSection")
...
#define SHEET_META__INSTRUMENT_CONFIG_SET_CC FM_STRING("cc")
...
#define SHEET_META__SET_CHORD FM_STRING("chord")
#define SHEET_META__SET_CHORD_VALUE_NULL FM_STRING("null")
#define SHEET_META__CALL_EVENTFUNCTION FM_STRING("call")
#define SHEET_META__SET_CC FM_STRING("cc")
#define SHEET_META__FADE_CC FM_STRING("fadeCC")
#define SHEET_META__BEGIN_TAG FM_STRING("beginTag")
#define SHEET_META__END_TAG FM_STRING("endTag")
